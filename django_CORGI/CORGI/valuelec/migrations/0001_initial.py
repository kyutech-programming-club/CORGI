    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lec_name_for_url', models.CharField(max_length=30, unique=True, validators=[django.core.validators.RegexValidator(message='英数字のみです', regex='^[a-zA-Z]*$')], verbose_name='講義名（ローマ字or英語）')),
